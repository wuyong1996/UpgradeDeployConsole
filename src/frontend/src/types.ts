...
export interface HostResult { backupBeforeDelete?: boolean | null; ok: boolean; noChanges?: boolean; message: string; commit: string | null; front: ServiceStatus | null; back: ServiceStatus | null; database: ServiceStatus | null; branches: { name: string; commit: string }[]; backupDirectory?: string | null }
